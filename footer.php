            ...
            <div class="row justify-content-around">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="">1626 HCM VN q8</a></li>
                            <li><a href="">Hotline: 08439.555.3635</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        <h4>Hotline</h4>
                        <ul class="list-unstyled">
                            <li><a href="">Gọi mua hàng: 5245.43223.363</a></li>
                            <li><a href="">Gọi kiếu nại: 09757.5266.274</a></li>
                            <li><a href="">Gọi bảo hành: 0989279.2134.981</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="copyright_text">
                            <P>
                                ...
                                </script> All rights reserved <i class="ti-heart" aria-hidden="true"></i> by <a href="" target="_blank">Banhang</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </P>
                        </div>
                    </div>
